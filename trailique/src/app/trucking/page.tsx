    ...
    <section>
      <div className="custom tq-t-20 tq-h-600 relative left-0 top-0 px-0 py-0 pt-16 sm:top-4 sm:pt-10 md:pt-10 lg:pt-12 mt-9 mb-5 ">
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold mt-0">
              Trucking Management Platform Development Solution
            </h1>
            <p className="mt-4 text-xl">
              Revolutionary Transportation Solution for Shippers, Drivers, and
              Transporters - Making Every Journey Convenient and Hassle-Free
            </p>
            <a
              href="#Solution"
              className="mb-0 ml-7 mt-18  inline-flex items-center rounded-full bg-blue-700 px-3 py-2 text-center text-xl font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Solution Insights
              <svg
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-md md:text-md text-gray-600 dark:text-white ">
          Streamline logistics, improve efficiency, and boost productivity with
          tailored software that meets your specific needs. Drive your business
          forward with our expert development services today!
        </p>
      </div>
