...
import FecCard from "@/components/Property/fec";
import Talk from "@/components/Property/talk";
import FeatureMain from "@/components/Property/FeatureMain";
...
">
        <div className="relative h-full w-full">
          <Image
            src="/images/property/property.webp"
            alt="taxi"
            layout="fill"
            objectFit="cover"
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="mb-10 w-screen pb-4 text-4xl font-bold">
              Property Management Platform Development Solution{" "}
            </h1>
            <p className="mt-3 text-xl ">
              Revolutionize Property Management with Our Custom Platform
