...
import Details from "@/components/cook/TaxiDetails";
import FecCard from "@/components/cook/fec";
import Talk from "@/components/cook/talk";
import FeatureMain from "@/components/cook/FeatureMain";
    ...
    <section>
        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              Cook Platform Development Solution
            </h1>
            <p className="mb-8 mt-3 text-xl">
              Cook up success with our comprehensive platform development
              solution tailored for the culinary industry.
            </p>
            <a
              href="#Solution"
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-white  md:text-xl ">
          From recipe management to online ordering, we've got you covered.
          Elevate your business with our innovative technology today!
        </p>
      </div>
      ...
      <div className="mt-6 flex justify-center">
        <a
          href="#FeatureMain"
          className=" flex items-center text-xl text-blue-600 hover:text-blue-700"
        >
