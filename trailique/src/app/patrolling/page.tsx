...
import PaTaxi from "@/components/patrolling/TaxiDetails";
import PaFecCard from "@/components/patrolling/fec";
import PaTalk from "@/components/patrolling/talk";
import PaFeatureMain from "@/components/patrolling/FeatureMain";
    ...
    <section>
      <div className="custom tq-t-20 tq-h-600 relative left-0 top-0 px-0 py-0 pt-16 sm:top-4 sm:pt-10 md:pt-10 lg:pt-12 mt-9 mb-5">
        <div className="relative h-full w-full">
          <Image
            src="/images/patrolling/patrol.webp"
            alt="taxi"
            layout="fill"
            objectFit="cover"
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              Top Solutions for Patrolling Platform Development
            </h1>
            <p className="mt-3 text-2xl">
              From advanced security features to user-friendly interfaces,
              explore how these tools can elevate your security operations.
            </p>
            <a
              href="#Solution"
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-white  md:text-xl">
          Optimize efficiency and enhance safety with our expertly curated
