...
import Details from "@/components/B2B/Details";
import FecCard from "@/components/B2B/fec";
import Talk from "@/components/B2B/talk";
import FeatureMain from "@/components/B2B/FeatureMain";
    ...
    <section>
        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              B2B E-Commerce Platform Development Solution
            </h1>
            <p className="mb-8 mt-3 text-xl">
              B2B E-commerce streamlines wholesale operations with a digital
              marketplace for efficient buying, selling and partnership
              management.
            </p>
            <a
              href="#Solution"
              className="mb-0 ml-8 mt-8 inline-flex items-center rounded-full bg-blue-700 px-3 py-2 text-center text-xl font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Solution Insights
              <svg
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-white  md:text-xl">
          Revolutionize your B2B e-commerce experience with our cutting-edge
          application. Streamline transactions, enhance customer relationships,
