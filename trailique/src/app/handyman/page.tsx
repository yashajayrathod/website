...
import Details from "@/components/handyman/TaxiDetails";
import FecCard from "@/components/handyman/fec";
import Talk from "@/components/handyman/talk";
import FeatureMain from "@/components/handyman/FeatureMain";
    ...
    <section>
      <div className="custom tq-t-20 tq-h-600 relative left-0 top-0 px-0 py-0 pt-16 sm:top-4 sm:pt-10 md:pt-10 lg:pt-12 mt-9 mb-5 ">
        <div className="relative h-full w-full">
          <Image
            src="/images/handyman/handyman.webp"
            alt="taxi"
            layout="fill"
            objectFit="cover"
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              Handyman Platform Development Solution
            </h1>
            <p className="mt-4 text-xl">
              Streamline operations, connect with customers, and grow your
              business with our innovative technology. Get started today and
              watch your handyman business thrive!
            </p>
            <a
              href="#Solution"
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-md md:text-md text-gray-600 dark:text-white">
          Our team of experts will create user-friendly, efficient platform
          tailored to your needs, helping you streamline operations and attract
          more customers.
        </p>
      </div>
