...
import Details from "@/components/Tele/Details";
import FecCard from "@/components/Tele/fec";
import Talk from "@/components/Tele/talk";
import FeatureMain from "@/components/Tele/FeatureMain";
    ...
    <section>
        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              Telemedicine Platform Development Solution{" "}
            </h1>
            <p className="mt-3 text-xl">
              Enhance patient care, streamline operations and reach more people
              with our customizable and user-friendly telemedicine technology.
            </p>
            <a
              href="#Solution"
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-white  md:text-xl">
          ...
          using our user-friendly telemedicine patient application.{" "}
        </p>
      </div>
