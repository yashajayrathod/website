              ...
              <div>
                ...
                <div className="px-12">
                  <ul className="list-disc">
                    ...
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      FShift timing : 9:30 to 18:30 IST (Work from Pune Office
                ...
                <div>
                  ...
                  <div>
                    <p className="mb-10 px-7 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                      Send your updated CV along with your cover letter to
                      <a
                        href="mailto:careers@trailique.com "
                        className="text-base text-blue-500 duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                      >
