        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              Efficiently Manage Laboratory Tasks for HMS Staff: Enhance Precision and ETA Communication.
              </h2>
              {/* Content */}
              <p className="text-sm dark:text-white md:text-base lg:text-lg text-center md:text-left">
              Enhance precision and streamline lab operations for HMS staff by efficiently managing all the tasks. Optimize workflow and ensure seamless operations with our tailored solutions.
{" "}
              </p>
              {/* Sliders */}
              <div className="mt-6 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2">
                <div className="rounded-md border p-4">
                  ...
                  Enter test orders, perform diagnostic tests and record results accurately.
                  </p>
                </div>
                {/* Other sliders */}
                ...
                <div className="rounded-md border p-4">
                  ...
                  Track sample collection, processing and analysis to ensure 
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm dark:text-white text-gray-600 lg:text-left">
                  Monitor and maintain laboratory equipment, reagents and procedures to meet quality standards.
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm dark:text-white text-gray-600 lg:text-left">
                  Manage laboratory supplies, reagents and consumables to prevent stockouts and wastage.                  </p>
                </div>
              </div>
