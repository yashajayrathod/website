        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              Efficient Front Desk Staff: Expert in Data Entry, Patient and all the stakeholders Management, along with Swift Assistance.              </h2>
              {/* Content */}
              <p className="text-sm dark:text-white md:text-base lg:text-lg text-center md:text-left">
              Master the art of efficient front desk operations with expertise
               in data entry and other stakeholders management.
                Deliver swift assistance to everyone with precision, 
              ...
              <div className="mt-6 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2">
                <div className="rounded-md border p-4">
                  ...
                  Manage patient appointments, reschedule as needed and send reminders.
                  </p>
                </div>
                {/* Other sliders */}
                ...
                <div className="rounded-md border p-4">
                  ...
                  Collect patient information, verify insurance coverage
                   and create patient records.
                  </p>
                </div>
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm dark:text-white text-gray-600 lg:text-left">
                  Handle patient billing, process payments and 
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm dark:text-white text-gray-600 lg:text-left">
                  Assist patients with inquiries, provide directions and address concerns promptly.
          ...
          <div className="order-1 w-full px-4 text-right lg:order-2 lg:w-1/2">
            ...
            >
              <Image
                src="/images/hm/receptionpanel.png"
                alt="Passenger"
                width={555}
                height={506}
