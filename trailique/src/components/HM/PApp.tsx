      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          <Image
            ...
            src="/images/hm/compoundingandspec.jpg"
            alt="Location Icon"
            className="mr-2 h-6 w-6"
          />{" "}
          {/* Use your icon or image here */}
      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          <Image
            ...
            src="/images/hm/medicationadherence.jpg"
            alt="Location Icon"
            className="mr-2 h-6 w-6"
          />{" "}
          {/* Use your icon or image here */}
      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          <Image
            ...
            src="/images/hm/medicationreconciliation.jpg"
            alt="Location Icon"
            className="mr-2 h-6 w-6"
          />{" "}
          {/* Use your icon or image here */}
      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          <Image
            ...
            src="/images/hm/regulatorycompliance.jpg"
            alt="Location Icon"
            className="mr-2 h-6 w-6"
          />{" "}
          {/* Use your icon or image here */}
