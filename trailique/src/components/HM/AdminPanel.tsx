        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              Simplify Stakeholder Management with our Comprehensive 
              Admin Application.{" "}
              </h2>
              {/* Content */}
              <p className="text-center lg:text-left">
              Streamline your administrative tasks effortlessly.
               Our all-encompassing admin application simplifies
                managing patients, doctors, nurses, receptionists,
                 labs, pharmacies, insurance providers and more.
              ...
              Seamlessly integrate telemedicine platforms for virtual consultations and remote patient monitoring.
                ...
                <div className="rounded-md border p-4">
                  ...
                  Assign roles and permissions, manage user accounts and oversee system configuration.
                  </p>
                </div>
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center dark:text-white text-sm text-gray-600 lg:text-left">
                  Monitor hospital performance metrics, system usage and user activity.
                ...
                <div className="rounded-md border p-4">
                  ...
                  Track user actions and system changes for accountability and compliance.
                  </p>
                </div>
              </div>
