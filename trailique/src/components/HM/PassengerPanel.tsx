        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              Efficient Doctor App for HMS: Streamline Patient Care and interaction with other roles with Intuitive UI.
              </h2>
              {/* Content */}
              <p className="text-center lg:text-left">
              Streamline patient care and enhance interaction with our 
              efficient doctor app for HMS. Our intuitive UI simplifies 
              tasks, ensuring seamless coordination across all roles.
              ...
              Access comprehensive patient records, including medical history and treatment plans.
                  </p>
                </div>
                {/* Other sliders */}
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center dark:text-white text-sm text-gray-600 lg:text-left">
                  Receive alerts for drug interactions, allergies and evidence-based treatment recommendations.
                  </p>
                </div>
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center dark:text-white text-sm text-gray-600 lg:text-left">
                  Conduct virtual consultations with patients for follow-up care and remote diagnosis.
                  </p>
                </div>
                <div className="rounded-md border p-4">
                  <h3 className="mb-2 text-center dark:text-white text-lg font-medium text-gray-800 lg:text-left">
                  ...
                  Prescribe medications, review medication history and track medication administration.                  </p>
                </div>
              </div>
