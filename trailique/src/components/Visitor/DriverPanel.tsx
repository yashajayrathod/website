      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              <h2 className="mb-4 text-center text-xl font-bold md:text-left md:text-3xl lg:text-4xl">
                Streamline Check-In Process with Pre-Registration for Seamless
                Visitor Experience
              </h2>
              {/* Content */}
              <p className="text-center text-sm md:text-left md:text-base lg:text-lg">
                Manage your hosts effortlessly with our visitor management
                system. Say goodbye to long queues and hello to efficiency!
              </p>
              {/* Sliders */}
              <div className="mt-6 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2">
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Efficient management of visitor records, including
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Instant notification alerts for hosts upon visitor arrival,
                    enabling timely reception and assistance.
                  </p>
                </div>
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Option for pre-registering visitors, streamlining the
                    check-in process and reducing administrative overhead.
                  </p>
                </div>
                <div className="rounded-md border p-4">
                  <h3 className="mb-2 text-center text-lg font-medium text-gray-800 lg:text-left dark:text-white">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Analytics dashboard for insights into visitor traffic,
                    trends and patterns.
                  </p>
                </div>
              </div>
          ...
          <div className="order-1 w-full px-4 text-right lg:order-2 lg:w-1/2">
            ...
            >
              <Image
                src="/images/visitor/visitor2.png"
                alt="Passenger"
                width={555}
                height={506}
