...
import PassengerApp from "./EvPassengerApp";
import DriverApp from "./EvDriverApp";
import AdminApp from "./EvAdminApp";
import Image from "next/image";
import "./Details.css";

function EvFeatureMain() {
