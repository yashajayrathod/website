          ...
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              <h2 className="mb-4 text-center text-xl font-bold md:text-left md:text-3xl lg:text-4xl">
                Effortlessly Manage Orders, Track Earnings & More with Our
                Intuitive Delivery Platform
              </h2>
              {/* Content */}
              <p className="text-center text-sm md:text-left md:text-base lg:text-lg">
                Access automated optimized routes for seamless deliveries and
                stay on top of your business with daily dashboard insights.
              </p>
              {/* Sliders */}
              <div className="mt-6 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2">
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Accept incoming delivery orders and manage the delivery
                    queue.
                  </p>
                </div>
                {/* Other sliders */}
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Access navigation tools for efficient route planning.
                  </p>
                </div>
                <div className="rounded-md border p-4">
                  <h3 className="mb-2 text-center text-lg font-medium text-gray-800 lg:text-left dark:text-white">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Confirm successful delivery and update order status.
                  </p>
                </div>
                <div className="rounded-md border p-4">
                  <h3 className="mb-2 text-center text-lg font-medium text-gray-800 lg:text-left dark:text-white">
