      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              <h2 className="mb-4 text-center text-xl font-bold md:text-left md:text-3xl lg:text-4xl">
                Ultimate Babysitter Admin App: Effortlessly Manage Parents,
                Babysitters, Schedules and Operations
              </h2>
              {/* Content */}
              <p className="text-center text-sm md:text-left md:text-base lg:text-lg">
                Streamline your childcare business with ease and efficiency. Try
                it now for stress-free babysitting management!
              </p>
              {/* Sliders */}
              <div className="mt-6 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2">
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Manage user accounts including parents and babysitters
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Integrate with third-party background check services to
                    verify the credibility and reliability of babysitters.
                  </p>
                </div>
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Set and manage service fees, commissionsand payment
                    processing rates for transactions conducted through the
                    platform.
                  </p>
                </div>
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Provide timely customer support and assistance to users,
                    addressing inquiries, resolving issues and ensuring a
          ...
          <div className="order-1 w-full px-4 text-right lg:order-2 lg:w-1/2">
            ...
            >
              <Image
                src="/images/babysitter/child-ADMIN.png"
                alt="Passenger"
                width={555}
                height={506}
