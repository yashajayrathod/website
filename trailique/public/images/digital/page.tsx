      ...
      <div className="relative min-h-screen px-0 py-16 md:py-20 lg:py-28">
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            ...
            <p className="text-xl">
            Revolutionize Pharmacy Services with Our Digital Platform Development Solution
Solution Insights 
            </p> 
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        Enhance efficiency, improve customer experience, and stay ahead of the competition. Revolutionize your pharmacy today!
