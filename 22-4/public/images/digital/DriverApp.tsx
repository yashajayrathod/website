    ...
    <div className="m-10  grid grid-cols-1 justify-center gap-4 sm:grid-cols-3">
      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          ...
          <h3 className="text-lg font-medium text-gray-800">Medication Dispensing Alerts</h3>
        </div>
      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          ...
          />{" "}
          {/* Use your icon or image here */}
          <h3 className="text-lg font-medium text-gray-800">Compounding and Specialty Services</h3>
        </div>
        <p className="text-sm text-gray-600">
      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          ...
          />{" "}
          {/* Use your icon or image here */}
          <h3 className="text-lg font-medium text-gray-800">Clinical Monitoring Services</h3>
        </div>
        <p className="text-sm text-gray-600">
      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          ...
          />{" "}
          {/* Use your icon or image here */}
          <h3 className="text-lg font-medium text-gray-800">Specialty Medication Management</h3>
        </div>
        <p className="text-sm text-gray-600">
      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          ...
          />{" "}
          {/* Use your icon or image here */}
          <h3 className="text-lg font-medium text-gray-800">Medication Adherence Programs</h3>
        </div>
        <p className="text-sm text-gray-600">
      ...
      <div className="rounded-md border p-4">
        <div className="mb-2 flex items-center">
          ...
          />{" "}
          {/* Use your icon or image here */}
          <h3 className="text-lg font-medium text-gray-800">Medication Therapy Outcomes Reporting</h3>
        </div>
        <p className="text-sm text-gray-600">
