...
function FeatureMain() {
  ...
  return (
    <section>
      ...
      {/* Navigation bar */}
      <div className="sticky top-0 z-10 mb-4 ml-20 mr-20 mt-10 flex justify-between bg-white text-4xl font-bold  dark:bg-slate-900">
        <button
          style={{
            marginRight: "20px",
            borderBottom:
        ...
        >
          <Image
            ...
            alt="Passenger Icon"
            className="center mb-1 ml-3 h-20 w-20 rounded-full p-1 "
          />
          Pharmacist App
        </button>
        <button
        ...
        >
          <Image
            ...
            alt="Passenger Icon"
            className="center mb-1 ml-5 h-20 w-20 rounded-full p-1 "
          />
          Admin Panel
        </button>
