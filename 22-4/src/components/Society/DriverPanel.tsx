      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              <h2 className="mb-4 text-center text-xl font-bold md:text-left md:text-3xl lg:text-4xl">
                Efficiently Manage Discussions, Minutes, AGMs, Voting and
                Elections!
              </h2>
              {/* Content */}
              <p className="text-center text-sm md:text-left md:text-base lg:text-lg">
                Conduct discussions, keep track of minutes of meetings, host
                Annual General Meetings, facilitate voting and seamlessly
                conduct elections with ease.
              </p>
              {/* Sliders */}
              <div className="mt-6 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2">
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center dark:text-white text-sm text-gray-600 lg:text-left">
                    Manage society finances, including maintenance fees,
                    utilities and other expenses, with built-in accounting
                    tools.
                  </p>
                </div>
                {/* Other sliders */}
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center dark:text-white text-sm text-gray-600 lg:text-left">
                    Monitor and manage common facilities, including scheduling
                    maintenance and ensuring proper upkeep.
                  </p>
                </div>
                ...
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm dark:text-white text-gray-600 lg:text-left">
                    Store and organize important documents such as bylaws,
                    meeting minutes and financial reports securely.
                  </p>
                </div>
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 dark:text-white lg:text-left">
                    Track and resolve resident complaints and concerns
                    efficiently to maintain satisfaction and harmony within the
                    community.
                  </p>
                </div>
              </div>
          ...
          <div className="order-1 w-full px-4 text-right lg:order-2 lg:w-1/2">
            ...
            >
              <Image
                src="/images/society/society2.png"
                alt="Passenger"
                width={555}
                height={506}
