      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              <h2 className="mb-4 text-center text-xl font-bold md:text-left md:text-3xl lg:text-4xl">
                Ultimate Platform to Connect Families with Trusted Childcare
                Providers!
              </h2>
              {/* Content */}
              <p className="text-center text-sm md:text-left md:text-base lg:text-lg">
                Effortlessly Connect Families with Top Childcare Providers:
                Streamline Scheduling, Communicationand Payments!
              </p>
              {/* Sliders */}
              <div className="mt-6 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2">
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Easily find babysitters based on specific criteria such as
                    age, experience, availabilityand location.
                  </p>
                </div>
                {/* Other sliders */}
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Communicate securely with potential babysitters through the
                    app's built-in messaging system to discuss requirements and
                    details.
                  </p>
                </div>
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Access background check reports for babysitters to ensure
                    safety and trustworthiness before hiring.
                  </p>
                </div>
                <div className="rounded-md border p-4">
                  <h3 className="mb-2 text-center text-lg font-medium text-gray-800 lg:text-left dark:text-white">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Conveniently book babysitting appointments and securely
                    process payments within the app for hassle-free
                    transactions.
                  </p>
                </div>
              </div>
          ...
          <div className="order-1 w-full px-4 text-right lg:order-2 lg:w-1/2">
            ...
            >
              <Image
                src="/images/babysitter/childcare.png"
                alt="Passenger"
                width={555}
                height={506}
