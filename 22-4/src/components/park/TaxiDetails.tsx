      ...
      <div className=" top-0 z-10 mb-4 ml-1 mr-1 mt-10 flex justify-between bg-white text-4xl font-bold  dark:bg-slate-900">
        ...
        >
          <Image
            width={50}
            height={30}
            src="/images/park/parkowner.jpg"
            alt="Passenger Icon"
            className="center mb-1 ml-4 mt-6 h-20 w-20 rounded-full border border-gray-400 p-1 "
          />
        ...
        >
          <Image
            ...
            alt="Passenger Icon"
            className="center mb-1 ml-0 h-20 w-20 rounded-full border border-gray-400 p-1 "
          />
          Admin Panel
        </button>
