  ...
  return (
    <section>
      ...
      <div className=" top-0 z-10 mb-4 ml-1 mr-1 mt-10 flex justify-between bg-white text-4xl font-bold  dark:bg-slate-900">
        ...
        >
          <Image
            src="/images/house/iconclient.jpg"
            alt="Passenger Icon"
        ...
        >
          <Image
            src="/images/house/iconhouse.jpg"
            alt="Passenger Icon"
            width={90} // Adjust width and height as needed
            height={90}
            className="mx-auto mb-1 ml-7 h-20 w-20 rounded-full border border-gray-400 p-1" // Adjust styling as needed
          />
          Housekeeper
        </button>
        <button
        ...
        >
          <Image
            ...
            width={90} // Adjust width and height as needed
            height={90}
            className="mx-auto mb-1 ml-3 mt-6 h-20 w-20 rounded-full border border-gray-400 p-1" // Adjust styling as needed
          />
          Admin Panel
        </button>
