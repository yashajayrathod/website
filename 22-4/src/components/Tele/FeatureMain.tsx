      ...
      <div className=" top-0 z-10 mb-4 ml-1 mr-1 mt-10 flex justify-between bg-white text-4xl font-bold  dark:bg-slate-900">
        ...
        >
          <Image
            width={90}
            height={90}
            src="/images/tele/doctor.jpg"
            alt="Passenger Icon"
            className="mx-auto mb-1 ml-4 h-20 w-20 rounded-full border border-gray-400 p-1" // Adjust styling as needed
          />
          Doctor
        </button>
        <button
        ...
        >
          <Image
            ...
            alt="Passenger Icon"
            className="mx-auto mb-1 ml-11 h-20 w-20 rounded-full border border-gray-400 p-1" // Adjust styling as needed
          />
          Admin Dashboard
        </button>
