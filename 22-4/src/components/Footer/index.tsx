...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-8 ml-3 max-w-[360px] lg:mb-16 ">
              <Link href="/" className="mb-8 inline-block">
                <Image
                  src="/images/about/favicon.ico"
                  alt="logo"
                  className=" dark:hidden ml-11 "
                  width={90}
                  height={90}
                />
                <Image
                  src="/images/about/favicon.ico"
                  alt="logo"
                  className="hidden ml-11 dark:block"
                  width={90}
                  height={90}
                />
              </Link>
              ...
              <div className="flex items-center">
                <a
                  href="https://www.facebook.com/profile.php?id=61555745280639"
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 22 22"
                    fill="none"
                    xmlns="http2://www.w3.org/2000/svg"
                ...
                <a
                  href="https://twitter.com/TrailiqueInfo"
                  aria-label="social-link"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mr-6 text-body-color duration-300 hover:text-black dark:text-body-color-dark dark:hover:text-primary"
                >
                  <svg
                    width="24"
                    height="24"
                ...
                <a
                  href="https://www.youtube.com/channel/UCCORoavk-ADmBL6-dPn13JA"
                  aria-label="social-link"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                ...
                <a
                  href="https://www.linkedin.com/company/trailiqueinfotech/mycompany/"
                  aria-label="social-link"
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      <div className="py-8">
        <p className="text-center text-base text-body-color hover:text-primary dark:text-white">
          © 2024 Trailique Infotech. All Rights Reserved.
        </p>
      </div>
      ...
      <Script
        async
        src="https://www.googletagmanager.com/gtag/js?id=G-5PHVPZKRTM"
      ></Script>
