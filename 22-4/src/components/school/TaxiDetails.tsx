      ...
      <div className=" top-0 z-10 mb-4 ml-1 mr-1 mt-10 flex justify-between bg-white text-4xl font-bold  dark:bg-slate-900">
        ...
        >
          <Image
            width={50}
            height={30}
            src="/images/school/photo.png"
            alt="Passenger Icon"
            className="center mb-10 ml-3 h-20 w-20 rounded-full border border-gray-400 p-1 "
          />
          Parent
        </button>
        <button
        ...
        >
          <Image
            width={50}
            height={30}
            src="/images/school/useraccount.png"
            alt="Passenger Icon"
