          ...
          <div className="order-2 m-0 pt-0 lg:order-1 lg:w-1/2">
            <div className="mb-6">
              ...
              <h2 className="mb-4 text-center text-xl font-bold md:text-left md:text-3xl lg:text-4xl">
                Transform Your Child Care Business with Our Cutting-Edge Admin
                Platform
              </h2>
              {/* Content */}
              <p className="text-center text-sm md:text-left md:text-base lg:text-lg">
                Streamline operations, enhance communication and elevate the
                care you provide.
              </p>
              {/* Sliders */}
              <div className="mt-6 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2">
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Role-based access control for managing staff, parents and
                    caregiver accounts.
                  </p>
                </div>
                {/* Other sliders */}
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Oversight of daily attendance records and reporting for
                    compliance purposes.
                  </p>
                </div>
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Billing and invoicing tools for managing payments, expenses
                    and budgeting.
                  </p>
                </div>
                <div className="rounded-md border p-4">
                  ...
                  <p className="text-center text-sm text-gray-600 lg:text-left dark:text-white">
                    Centralized calendar for scheduling events, activities and
                    staff shifts.
                  </p>
                </div>
              </div>
