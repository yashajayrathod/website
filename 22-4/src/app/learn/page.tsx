...
function TaxiDetails() {
  return (
    <section>
      <div className="custom tq-t-20 tq-h-600 relative left-0  top-0 mt-8 px-0 py-16 sm:top-4 sm:py-20 md:left-0 md:py-20 lg:py-28">
        <div className="relative h-full w-full">
          <Image
            ...
            width={1920}
            height={600}
            className=" aspect-w-16 aspect-h-9 h-auto w-full object-cover"
          />
