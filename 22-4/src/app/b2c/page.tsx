...
import BBFeatureMain from "@/components/b2c/FeatureMain";
import BBTaxi from "@/components/b2c/Details";
    ...
    <section>
        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              B2C E-Commerce Platform Development Solution{" "}
            </h1>
            <p className="mb-8 mt-3 text-2xl">
              Transform Your Business with Our B2C E-Commerce Platform
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-white  md:text-xl">
          Discover Seamless Shopping Experiences, Personalized Recommendations
          and Secure Transactions - Elevate Your Online Retail Game Today!
        </p>
      </div>
