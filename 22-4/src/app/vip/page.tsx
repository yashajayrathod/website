...
import Details from "@/components/VIP/Details";
import FecCard from "@/components/VIP/fec";
import Talk from "@/components/VIP/talk";
import FeatureMain from "@/components/VIP/FeatureMain";
  ...
  return (
    <section>
        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 transform text-center text-white md:w-3/4">
            <h1 className="mb-6 text-3xl font-bold sm:text-4xl md:text-4xl">
              VIP Transportation Platform Development Solution
            </h1>
            <p className="sm:text-md mb-10 mt-10 text-xl ">
              Ultimate VIP Transport Experience with Exclusive Vehicles,
              Bodyguard Deployment, Instant Emergency Highlights, Safe Routing,
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-white md:text-sm ">
          Experience VIP Transport with Exclusive Vehicles and Instant Emergency
          Highlights.
        </p>
      </div>
