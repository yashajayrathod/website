...
import Details from "@/components/school/TaxiDetails";
import FecCard from "@/components/school/fec";
import Talk from "@/components/school/talk";
import FeatureMain from "@/components/school/FeatureMain";
    ...
    <section>
        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              School Transportation Platform Development Solution{" "}
            </h1>
            <p className="mt-3 text-xl">
              Supercharge your School Transportation! Boost and automate your
              operations with a dynamic solution.
            </p>
            <a
              href="#Solution"
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-md md:text-md text-gray-600 dark:text-white ">
          A complete School Transport Solution Meeting Every Stakeholder's Needs
        </p>
      </div>
