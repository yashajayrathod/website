...
function BuTaxiDetails() {
  return (
    <section>
      <div className="custom  tq-t-20 tq-h-600 relative  left-0 top-0 px-0 py-16 sm:top-4 sm:py-20 md:py-20 lg:py-28 ">
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="mt-28 w-screen pb-4 text-4xl font-bold">
              B2B2C E-Commerce Platform Development Solution
            </h1>
            <p className="mb-10 mt-1 text-2xl">
