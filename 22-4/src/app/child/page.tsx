...
import Details from "@/components/child/TaxiDetails";
import FecCard from "@/components/child/fec";
import Talk from "@/components/child/talk";
import FeatureMain from "@/components/child/FeatureMain";
    ...
    <section>
        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              Child Care Platform Development Solution
            </h1>
            <p className="mb-8 mt-3 text-xl">
              Elevate your childcare business with our comprehensive platform
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-white  md:text-xl">
          Our development services cater to the unique needs of child care
          providers, offering seamless management tools and enhanced parent
          communication.
        </p>
      </div>
