...
import Event from "@/components/Digital/Details";
import FecCard from "@/components/Digital/fec";
import Talk from "@/components/Digital/talk";
import FeatureMain from "@/components/Digital/FeatureMain";
    ...
    <section>
      <div className="custom  tq-t-20 tq-h-600 relative  left-0 top-0 px-0 py-16 sm:top-4 sm:py-20 md:left-0 md:py-20 lg:py-28 ">
        <div className="relative h-full w-full">
          <Image
            src="/images/digital/digital pharma (2).webp"
            alt="taxi"
            layout="responsive"
            width={1920}
            height={600}
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              Digital Pharmacy Platform Development Solution
            </h1>
            <p className="mt-3 text-xl">
              Revolutionize Pharmacy Services with Our Digital Platform
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-white  md:text-xl">
          Enhance efficiency, improve customer experience and stay ahead of the
          competition. Revolutionize your pharmacy today!
        </p>
      </div>
