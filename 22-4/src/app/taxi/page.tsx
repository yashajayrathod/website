...
import Taxi from "@/components/taxipage/TaxiDetails";
import FecCard from "@/components/taxipage/fec";
import Talk from "@/components/taxipage/talk";
import FeatureMain from "@/components/taxipage/FeatureMain";
    ...
    <section>
        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              Taxi Dispatch Platform Development Solution
            </h1>
            <p className="sm:text-md mt-3 text-xl">
              Supercharge your taxi business! Boost and automate your operations
              with a dynamic white label taxi app solution.
            </p>
            <a
              href="#Solution"
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-white md:text-xl">
          Experience a top-notch taxi app development solution that puts
