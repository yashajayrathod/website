...
import Details from "@/components/Visitor/Details";
import FecCard from "@/components/Visitor/fec";
import Talk from "@/components/Visitor/talk";
import FeatureMain from "@/components/Visitor/FeatureMain";
    ...
    <section>
      <div className="custom  tq-t-20 tq-h-600 relative  left-0 top-0 px-0 py-16 sm:top-4 sm:py-20 md:left-0 md:py-20 lg:py-28 ">
        <div className="relative h-full w-full">
          <Image
            src="/images/visitor/visitor.webp"
            alt="taxi"
            layout="responsive"
            width={1920}
            height={600}
            className="aspect-w-16 aspect-h-9 mt-2  h-auto w-full object-cover sm:mt-4 sm:py-5"
          />
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center text-white">
            <h1 className="w-screen pb-4 text-4xl font-bold">
              Visitor Management Development Solution
            </h1>
            <p className="mt-3 text-2xl">
              Make your visitors entry and exit flawless, convenient and
              hassle-free, with no waiting.
            </p>
            <a
              href="#Solution"
      ...
      <div id="Solution" className="md-20 mt-0 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-white  md:text-xl">
          To gain insight into visitor behavior and preferences, consider
          implementing a comprehensive analytics tool like Google Analytics or
          Mixpanel.
        </p>
      </div>
